        ...
        child: Row(
          ...
          children: <Widget>[
            Container(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  Text("0", style: TextStyle(fontSize: 17.0,color:Color(0xFFD3D3D3),),),
                   InkWell(
                     onTap: (){},
            ...
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: <Widget>[
                Text("Thali",style: TextStyle(fontSize: 16.0,fontWeight:FontWeight.bold),),
                SizedBox(height: 5.0,),
                  ...
                  child: ListView(
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        child: Row(
                          children: <Widget>[
                            Text("lunch", style: TextStyle(color: Colors.grey,fontWeight: FontWeight.bold),),
                            SizedBox(width: 5.0),
                            InkWell(
                                onTap: (){},
                                child: Text("x",
